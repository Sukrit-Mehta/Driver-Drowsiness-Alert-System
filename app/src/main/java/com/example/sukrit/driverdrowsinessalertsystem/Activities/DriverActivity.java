...
import com.example.sukrit.driverdrowsinessalertsystem.Adapters.DriverRidesAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabasePastTrips.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                DriverRidesAdapter driverRidesAdapter = new DriverRidesAdapter(arrayList,context);
                rvDriverRides.setAdapter(driverRidesAdapter);
            }
        ...
        rvDriverRides.setLayoutManager(new LinearLayoutManager(this));
        rvDriverRides.setAdapter(new DriverRidesAdapter(arrayList,this));
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent thisIntent = new Intent(DriverActivity.this,PlaceSelectionActivity.class);
